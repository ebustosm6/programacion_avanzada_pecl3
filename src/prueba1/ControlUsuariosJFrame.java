...
public class ControlUsuariosJFrame extends javax.swing.JFrame {

    private boolean detenerReanudar = false;
    private Lock l = new ReentrantLock();
    public Condition c = l.newCondition();

    public ControlUsuariosJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlUsuariosJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlUsuariosJFrame().setVisible(true);
            }
        });
