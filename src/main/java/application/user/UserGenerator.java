...
public class UserGenerator extends Thread {
    ...
    private int randomSupervisorAge() {
        return (int) ((ApplicationGlobalConfig.USER_SUPERVISOR_LIMIT_AGE - ApplicationGlobalConfig.USER_ADULT_AGE) * Math.random()
    ...
    private void sleepStepGeneration() throws InterruptedException {
        sleep((long) ((ApplicationGlobalConfig.USER_GENERATION_MAX_MILISECONDS - ApplicationGlobalConfig.USER_GENERATION_MIN_MILISECONDS)
