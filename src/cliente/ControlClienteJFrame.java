 ...
 * @author cesar
 */
public class ControlClienteJFrame extends javax.swing.JFrame {

    /**
     * Creates new form Cliente
     */
    private ControlCliente controladorCliente;

    public ControlClienteJFrame() throws RemoteException, NotBoundException, MalformedURLException {
    ...
    private void jButtonControlUbicacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonControlUbicacionActionPerformed
        try {
            ...
            Logger.getLogger(ControlClienteJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlClienteJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ControlClienteJFrame().setVisible(true);
